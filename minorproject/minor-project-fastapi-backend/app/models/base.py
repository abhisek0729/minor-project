...
class Hotel(Base):
    ...
    cover_image_url: Mapped[str | None] = mapped_column("coverImageUrl", Text)
    cover_image_public_id: Mapped[str | None] = mapped_column("coverImagePublicId", Text)
    created_at: Mapped[datetime] = mapped_column(DateTime, server_default=func.now())
...
class Restaurant(Base):
    ...
    restaurant_image_url: Mapped[str | None] = mapped_column("restaurant_image_url", String(255))
    location: Mapped[str] = mapped_column(String(255))
    phone_number: Mapped[str] = mapped_column(String(255))
    cuisine: Mapped[str] = mapped_column(String(255))
    established_date: Mapped[str | None] = mapped_column("established_date", String(50))
    is_open: Mapped[bool | None] = mapped_column("is_open", Boolean, default=True)
    opening_time: Mapped[str | None] = mapped_column("opening_time", String(50))
    closing_time: Mapped[str | None] = mapped_column("closing_time", String(50))
